...
"""
example of creating hdf5 data set that will be converted to xarray compatible h5 convention
    ...
    for alias, det in adets.items():
        for attr in dattrs[alias]:
            try:
                ...
                print(f'Error getting {nevt}, {alias}, {attr}')
